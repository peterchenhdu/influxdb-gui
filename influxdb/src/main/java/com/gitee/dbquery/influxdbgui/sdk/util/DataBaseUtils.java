...
import com.gitee.dbquery.influxdbgui.sdk.exception.DatabaseAlreadyExistException;
import com.gitee.dbquery.influxdbgui.sdk.dto.QueryRstDTO;
import com.gitee.dbquery.influxdbgui.sdk.dto.res.DatabaseCreateResDTO;
...
//        createSql = createSql + ";";
    ...
    public static void deleteDatabase(ConnectionDTO connection, String dbName) {
        RestConnectionUtils.executeUpdate(connection, Collections.singletonList("DROP DATABASE \"" + dbName + "\";"));
    }
